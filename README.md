# DeepContext OCR Pipeline — PDF para LLM Context
...
```bash
# 1. Mude de branch
git checkout ocr-pipeline-minio
...
# 5. Obtém índice e chaves dos chunks
...
|-----------------------|--------------------|------------------------------------|
| `REDIS_URL`           | redis://redis:6379 | Broker e backend Celery        |
